 ...
 * @file   : Ptty.jquery.js
 * @ver    : 1.0
 * @Author : Theodore Boersma
 * @url    : none
 * @desc   : Ptty, a Terminal for TheOS. 
 * @note   : Based on wterm.js by Venkatakrishnan Ganesh.
 * @license: Free to use and redistrobute
    ...
    * */
    var get_defaults = function() {
        ...
        return {
            ...
            welcome      : 'Welcome to the TheOS terminal. Type help for a list of commands!',
